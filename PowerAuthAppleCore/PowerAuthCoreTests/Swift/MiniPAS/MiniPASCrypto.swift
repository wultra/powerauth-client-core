...
class MiniPASCrypto {
	...
	static func CONVERT_32Bto16B(key: Data) throws -> Data {
		guard key.count == 32 else {
			throw Errors.invalidInputDataSize
		}
	...
	static func CalculateActivationFingerprint(serverPublicKey: ECKeyPair.KeyAgreement.PublicKey, clientPublicKey: ECKeyPair.KeyAgreement.PublicKey, activationId: String) throws -> String {
		guard let serverCompact = serverPublicKey.normalizedRepresentation else {
			throw Errors.ecKeyExportFailed
		}
	...
	static func AES_ECB_Encrypt(data: Data, key: Data, ivData: Data) throws -> Data {
		return try AES(data: data, key: key, ivData: ivData, operation: kCCEncrypt, options: kCCOptionECBMode)
	}
	...
	static func AES_ECB_Decrypt(data: Data, key: Data, ivData: Data) throws -> Data {
		return try AES(data: data, key: key, ivData: ivData, operation: kCCDecrypt, options: kCCOptionECBMode)
	}
	...
	static func AES_CBC_PKCS7_Encrypt(data: Data, key: Data, ivData: Data) throws -> Data {
		return try AES(data: data, key: key, ivData: ivData, operation: kCCEncrypt, options: kCCOptionPKCS7Padding)
	}
	...
	static func AES_CBC_PKCS7_Decrypt(data: Data, key: Data, ivData: Data) throws -> Data {
		return try AES(data: data, key: key, ivData: ivData, operation: kCCDecrypt, options: kCCOptionPKCS7Padding)
	}
	...
	static func AES_CBC_Encrypt(data: Data, key: Data, ivData: Data) throws -> Data {
		let encrypted = try AES(data: data, key: key, ivData: ivData, operation: kCCEncrypt, options: kCCOptionPKCS7Padding)
	...
	///   - ivData: IV data
	///   - operation: Encrypt or decrypt, use `kCCEncrypt` or `kCCDecrypt` constant.
	///   - mode: Options, use `CCOptions` constants.
	/// - Throws: In case of failure.
	/// - Returns: Encrypted or decrypted data.
	private static func AES(data: Data, key: Data, ivData: Data, operation: Int, options: Int) throws -> Data {
